...
class DjangoBusinessProfileRepository(BusinessProfileRepositoryInterface):
    def create(self, profile: DomainBusinessProfile) -> DomainBusinessProfile:
        try:
            django_profile = BusinessProfile.objects.create(
                **self._to_django_data(profile)
            )
            return self._to_domain_data(django_profile)
    ...
    def _to_django_data(self, profile: DomainBusinessProfile) -> dict:
        return {
    ...
    def _to_domain_data(self, django_profile: BusinessProfile) -> BusinessProfile:
...
class DjangoBusinessVerificationRepository(BusinessVerificationRepositoryInterface):
    def create(
        ...
        try:
            ...
            django_verification = BusinessVerification.objects.create(
                **self._to_django_data(verification)
            )
            return self._to_domain_data(django_verification)
    ...
    def get_by_user_id(self, user_id: int) -> DomainBusinessVerification:
        try:
    ...
    def _to_django_data(self, verification: DomainBusinessVerification) -> dict:
        return {
    ...
    def _to_domain_data(
        self, django_verification: BusinessVerification
    ) -> DomainBusinessVerification:
